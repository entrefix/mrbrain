        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 pb-4 sm:pb-6">
          ...
          >
            <div className="flex items-center gap-2 p-3 pb-2 sm:pb-3">
              ...
              {/* Image Upload Button */}
              <label className={`flex-shrink-0 group relative ${isImageUploading ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
                <input
                  type="file"
                ...
                <div className={`flex items-center justify-center w-9 h-9 rounded-lg transition-colors ${
                  ...
                  {isImageUploading ? (
                    ...
                    <Image size={18} weight="regular" className="text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" />
                  )}
                </div>
                {/* Tooltip */}
                {!isImageUploading && (
